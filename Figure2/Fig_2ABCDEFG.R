...
gq1 <- ggplot(raster_high_acid_transform) +
  ...
  theme_bw() +
  labs(fill = "") +
  #theme(legend.position = c(0.9, 0.1), legend.title = element_text(size = 10, color="black"),
...
gq2 <- ggplot(raster_high_phosphate_transform) +
  ...
  theme(legend.position = c(0.9, 0.23), legend.title = element_text(size=10, color="black"),
        legend.key.size = unit(0.3, 'cm'),
...
#grid.arrange(gq1, gq2, gq3, gq4, gq5, gq6, gq7, nrow=4, ncol=2)

jpeg( "Fig2A.jpg", width = 500, height = 400, quality = 100 ); gq1; dev.off()
jpeg( "Fig2B.jpg", width = 500, height = 400, quality = 100 ); gq2; dev.off()
jpeg( "Fig2C.jpg", width = 500, height = 400, quality = 100 ); gq3; dev.off()
jpeg( "Fig2D.jpg", width = 500, height = 400, quality = 100 ); gq4; dev.off()
jpeg( "Fig2E.jpg", width = 500, height = 400, quality = 100 ); gq5; dev.off()
jpeg( "Fig2F.jpg", width = 500, height = 400, quality = 100 ); gq6; dev.off()
jpeg( "Fig2G.jpg", width = 500, height = 400, quality = 100 ); gq7; dev.off()
