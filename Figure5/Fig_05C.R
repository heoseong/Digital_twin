...
#table( select$mmday, select$farm_id )
by( select$brix[select$farm_id == "Hab" ], select$mmday[select$farm_id == "Hab" ], summary )
by( select$brix[select$farm_id == "Iab" ], select$mmday[select$farm_id == "Iab" ], summary )

by( select$size[select$farm_id == "Hab" ], select$mmday[select$farm_id == "Hab" ], summary )
by( select$size[select$farm_id == "Iab" ], select$mmday[select$farm_id == "Iab" ], summary )
...
jpeg( "Figures/Fig5C.jpg", width = 700, height = 350, quality = 100 )
